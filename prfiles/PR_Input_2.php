...
<div id="content" class="span10">
	...
	<form action="../php/disbursementreq.php" method="POST">
		...
		<input id="inputfield" name="ppayee" type="text" style="width:306px;" required="required" placeholder="* "></input></div>
		
		<!-- Employee number -->
		<div style="position:absolute; left: 600px; top: 227px;">
		<input id="inputfield" name="pempnum" type="text" style="width:163px;height:15px;" required="required" placeholder="* "></input></div>
		
		<!-- ORS/BURS Number -->
		<div style="position:absolute; left: 788px; top: 227px;">
		<input id="inputfield" name="pobr" type="text" style="width:165px;height: 15px;" required="required" placeholder="* "></input></div>
		
		<!-- Telephone Number -->
		<div style="position:absolute; left: 840px; top: 255.5px;">
		<input id="inputfield" name="ptelephone" type="text" style="width:115px;" required="required" placeholder="* cell number "></input></div>
		
		<!-- Payee Address -->
		<div style="position:absolute; left: 270px; top: 255.5px;">
		<input id="inputfield" name="paddress" type="text" style="width:495px;" required="required" placeholder="* "></input></div>
		
		<!-- Particulars -->
		<div style="position:absolute; left: 210px; top: 340px;">
		<textarea id="inputfield" name="dparticular" type="text" style="height: 160px;width:310px;resize:none;overflow:auto;" required="required" placeholder="* "></textarea></div>
		...
		<textarea id="inputfield" name="dmfop" type="text" style="height: 160px;width:115.5px;resize:none;overflow:auto;" required="required" placeholder="* "></textarea></div>
		
		<!-- AMOUNT -->
		<div style="position:absolute; left: 840px; top: 340px;">
		<textarea id="inputfield" name="damount" type="text" style="height: 160px;width:123px;resize:none;overflow:auto;" required="required" placeholder="* "></textarea></div>
		
		<!-- Amount Due -->
		<div style="position:absolute; left: 850px; top: 545px;font-size:11px; font-family:'Consolas'; font-weight: bold;">Amount due here</div>
		
		<!-- Account Title -->
		<div style="position:absolute; left: 200px; top: 690px;">
		<input id="inputfield" name="title" type="text" style="width:405px;" required="required" placeholder="* "></input></div>
		
		<!-- UACS Code -->
		<div style="position:absolute; left: 630px; top: 690px;">
		<input id="inputfield" name="uacs" type="text" style="width:87px;" required="required" placeholder="* "></input></div>
		
		<!-- Debit -->
		<div style="position:absolute; left: 739px; top: 690px;">
		<input id="inputfield" name="debit" type="text" style="width:95px;" required="required" placeholder="* "></input></div>
		
		<!-- Credit -->
		<div style="position:absolute; left: 858px; top: 690px;">
		<input id="inputfield" name="credit" type="text" style="width:100px;" required="required" placeholder="* "></input></div>
		...
		<!-- <input id="inputfield" name="office" type="text" style="width:330px;" required="required"></input> -->
		</div>
		
		<!-- ADA NUMBER -->
		<div style="position:absolute; left:320px; top: 960px;">
		<input id="inputfield" name="ada" type="text" style="width:140px;height: 18px;" required="required" placeholder="* "></input></div>
		
		<!-- Bank Name -->
		<div style="position:absolute; left:720px; top: 935px;">
		<input id="inputfield" name="bname" type="text" style="width:115px;" required="required" placeholder="* "></input></div>
		
		<!-- Account Number -->
		<div style="position:absolute; left:750px; top: 975px;">
		<input id="inputfield" name="accnum" type="text" style="width:90px;" required="required" placeholder="* "></input></div>
		
		<!-- JEV Number -->
		<div style="position:absolute; left:875px; top: 975px;">
		<input id="inputfield" name="jev" type="text" style="width:75px;" required="required" placeholder="* "></input></div>
		
		<!-- Signature Above Payee Name -->
		<div style="position:absolute; left:310px; top: 1062px;">
		<!-- <input id="inputfield" name="office" type="text" style="width:180px;" required="required" placeholder=" "></input> -->
		</div>	
		...
		<input name="newdv" type="submit" id="button" value="CREATE" /></input></div>
	</form>
