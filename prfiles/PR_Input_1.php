...
<!-- start: CSS -->
    ...
    <!-- start: JavaScript-->
        ...
        $(document).ready(function(){
            ...
            '<label><input type="text" name="unit[]" style="width:63px; margin-left:10px;" required="required" placeholder="Unit"></input></label>' +
            '<label><input type="text" name="desc[]" style="width:318px; margin-left:10px;" required="required" placeholder="Description"></input></label>' +
            '<label><input type="text" name="qty[]" style="width:60px; margin-left:10px;" required="required" placeholder="Quantity"></input></label>' +
            '<label><input type="text" name="ucost[]" style="width:82.8px; margin-left:10px;" required="required" placeholder="Unit Cost"></input></label>'+
...
<div id="content" class="span10">
	...
	<form action="../php/purchasereq.php" method="POST">
		...
		<input id="inputfield" name="name" type="text" style="width:246px;" required="required" placeholder="* "></input></div>
		
		<!-- cluster -->
		<div style="position:absolute; left: 695px; top: 318px;">
		<input id="inputfield" name="cluster" type="text" style="width:246px;" required="required" placeholder="* "></input></div>
		
		<!-- office -->
		<div style="position:absolute; left: 190px; top: 390px;">
		<input id="inputfield" name="office" type="text" style="width:249px;" required="required" placeholder="* "></input></div>
		...
		<input id="inputfield" name="rscode" type="text" style="width:115px;" required="required" placeholder="* "></input></div>
		
		<!-- ITEMS PART -->
        
        <!-- BUTTON -->
         <div style="position: absolute; left: 157px; top: 565px;">
        ...
        <div class="form-group" style="position: absolute; left: 185px; top: 524px;">
		...
		<input id="inputfield" name="purpose" type="text" style="width:720px;" required="required" placeholder="* "></input></div>
		
		<!-- nameofofficer -->
		<div style="position:absolute; left: 350px; top: 950px;">
		<!-- <input id="inputfield" type="text" style="width:135px;" required="required" placeholder="Name of Officer"></input> -->
		</div>
